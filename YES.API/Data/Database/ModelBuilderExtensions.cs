    ...
    public static class ModelBuilderExtensions
    {
        ...
        private static void SeedEvents(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Event>(x =>
            {
                ...
                new Event { Id = 36, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                new Event { Id = 37, TicketProviderId = 3, VenueId = 9, Status = Status.SoldOut },
                new Event { Id = 38, TicketProviderId = 3, VenueId = 9, Status = Status.SoldOut },
                new Event { Id = 39, TicketProviderId = 3, VenueId = 9, Status = Status.SoldOut },
                new Event { Id = 40, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                new Event { Id = 41, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                new Event { Id = 42, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                new Event { Id = 43, TicketProviderId = 3, VenueId = 9, Status = Status.SoldOut },
                new Event { Id = 44, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                new Event { Id = 45, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                new Event { Id = 46, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                new Event { Id = 47, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                new Event { Id = 48, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                new Event { Id = 49, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                new Event { Id = 50, TicketProviderId = 3, VenueId = 9, Status = Status.SoldOut },
                new Event { Id = 51, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                new Event { Id = 52, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                new Event { Id = 53, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                new Event { Id = 54, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                new Event { Id = 55, TicketProviderId = 3, VenueId = 9, Status = Status.SoldOut },
                new Event { Id = 56, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
        ...
        private static void SeedEventInfo(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<EventInfo>(x =>
            {
                ...
                new EventInfo { Id = 13, EventId = 13, Name = "VJ Ward", EventDate = DateTime.ParseExact("10/09/2021 01:00:00", "dd/MM/yyyy HH:mm:ss", null), Description = "VJ Ward in the Mix", WebsiteUrl = "https://www.facebook.com/Dj.Ward.Impe/", BannerImgUrl = "https://scontent-bru2-1.xx.fbcdn.net/v/t1.6435-9/68947152_10156578134447644_7759879836461432832_n.png?_nc_cat=109&ccb=1-3&_nc_sid=09cbfe&_nc_ohc=IDm1dnxmhosAX-EYdU6&_nc_ht=scontent-bru2-1.xx&oh=18d225698aa70604374adbaf32077950&oe=60CA125B" },
                new EventInfo { Id = 14, EventId = 14, Name = "VJ Ward / eLiXir on Tour", EventDate = DateTime.ParseExact("10/10/2021 23:00:00", "dd/MM/yyyy HH:mm:ss", null), Description = "Na lang anticiperen krijgt VJ Ward een kans zich op het grote podium te bewijzen. Dit jonge talent draait overal de pannen van het dak, mis deze kans dus niet want de plaatsen zijn beperkt.", WebsiteUrl = "https://www.facebook.com/Dj.Ward.Impe/", BannerImgUrl = "https://scontent-bru2-1.xx.fbcdn.net/v/t1.6435-9/68947152_10156578134447644_7759879836461432832_n.png?_nc_cat=109&ccb=1-3&_nc_sid=09cbfe&_nc_ohc=IDm1dnxmhosAX-EYdU6&_nc_ht=scontent-bru2-1.xx&oh=18d225698aa70604374adbaf32077950&oe=60CA125B" },
        ...
        private static void SeedTicketProviders(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<TicketProvider>(x =>
            {
                ...
                x.HasData(
                new TicketProvider { Id = 1, NameProvider = "Vooruit", PhoneNumber = "09 267 28 20", Email = "info@vooruit.be", BankAccount = "BE78 3590 0754 7674", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")) },
                new TicketProvider { Id = 2, NameProvider = "WAREONE.world bvba", PhoneNumber = "09 147 27 78", Email = "info@tomorrowland.be", BankAccount = "BE78 7854 3585 7820", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")) },
                new TicketProvider { Id = 3, NameProvider = "Live Nation Festivals NV", PhoneNumber = "09 754 87 78", Email = "info@rockwerchter.be", BankAccount = "BE78 7768 3578 1220", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")) },
                new TicketProvider { Id = 4, NameProvider = "Couleur Cafe", PhoneNumber = "09 785 24 86", Email = "info@couleurcafe.be", BankAccount = "BE76 5455 8725 7824", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")) },
                new TicketProvider { Id = 5, NameProvider = "Chokri Mahassine", PhoneNumber = "09 765 78 86", Email = "info@pukkelpop.be", BankAccount = "BE34 8792 4687 2565", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")) },
