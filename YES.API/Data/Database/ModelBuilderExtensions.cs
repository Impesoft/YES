    ...
    public static class ModelBuilderExtensions
    {
        ...
        private static void SeedEventInfo(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<EventInfo>(x =>
            {
                ...
                new EventInfo { Id = 13, EventId = 13, Name = "VJ Ward", EventDate = DateTime.ParseExact("10/09/2021 01:00:00", "dd/MM/yyyy HH:mm:ss", null), Description = "VJ Ward in the Mix", WebsiteUrl = "https://www.facebook.com/Dj.Ward.Impe/", BannerImgUrl = "https://impesoft.org/images/Horizontal_logo.jpg" },
                new EventInfo { Id = 14, EventId = 14, Name = "VJ Ward / eLiXir on Tour", EventDate = DateTime.ParseExact("10/10/2021 23:00:00", "dd/MM/yyyy HH:mm:ss", null), Description = "Na lang anticiperen krijgt VJ Ward een kans zich op het grote podium te bewijzen. Dit jonge talent draait overal de pannen van het dak, mis deze kans dus niet want de plaatsen zijn beperkt.", WebsiteUrl = "https://www.facebook.com/Dj.Ward.Impe/", BannerImgUrl = "https://impesoft.org/images/Horizontal_logo.jpg" },
