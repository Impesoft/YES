    ...
    public static class ModelBuilderExtensions
    {
        ...
        private static void SeedTicketProviders(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<TicketProvider>(x =>
            {
                ...
                x.HasData(
                new TicketProvider { Id = 1, NameProvider = "Vooruit", GreetingName = "Vooruit", PhoneNumber = "09 267 28 20", Email = "info@vooruit.be", BankAccount = "BE78 3590 0754 7674", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketProvider },
                new TicketProvider { Id = 2, NameProvider = "WAREONE.world bvba", GreetingName = "WAREONE", PhoneNumber = "09 147 27 78", Email = "info@tomorrowland.be", BankAccount = "BE78 7854 3585 7820", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketProvider },
                new TicketProvider { Id = 3, NameProvider = "Live Nation Festivals NV", GreetingName = "Live Nation Festivals NV", PhoneNumber = "09 754 87 78", Email = "info@rockwerchter.be", BankAccount = "BE78 7768 3578 1220", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketProvider },
                new TicketProvider { Id = 4, NameProvider = "Couleur Cafe", GreetingName = "Live NationCouleur Cafe", PhoneNumber = "09 785 24 86", Email = "info@couleurcafe.be", BankAccount = "BE76 5455 8725 7824", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketProvider },
                new TicketProvider { Id = 5, NameProvider = "Chokri Mahassine",  GreetingName = "Chokri Mahassine", PhoneNumber = "09 765 78 86", Email = "info@pukkelpop.be", BankAccount = "BE34 8792 4687 2565", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketProvider },
                new TicketProvider { Id = 6, NameProvider = "Extrema", GreetingName = "Extrema", PhoneNumber = "09 485 35 41", Email = "info@extremaoutdoor.be", BankAccount = "BE55 7865 7874 1237", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketProvider },
                new TicketProvider { Id = 7, NameProvider = "Sportpaleis Group NV", GreetingName = "Sportpaleis Group NV", PhoneNumber = "09 879 87 74", Email = "info@sportpaleisgroup.be", BankAccount = "BE78 6872 3968 7821", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketProvider },
                new TicketProvider { Id = 8, NameProvider = "eLiXir", GreetingName = "eLiXir", PhoneNumber = "09 782 71 42", Email = "info@elixir.be", BankAccount = "BE55 7865 7874 1237", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketProvider },
                new TicketProvider { Id = 9, NameProvider = "Team Trix", GreetingName = "Team Trix", PhoneNumber = "09 456 79 17", Email = "info@trix.be", BankAccount = "BE55 4752 7836 4878", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketProvider },
                new TicketProvider { Id = 10, NameProvider = "Chez Nique vzw",  GreetingName = "Mama Nick is baas", PhoneNumber = "09 022 44 57", Email = "info@cheznique.be", BankAccount = "BE57 7862 1427 3457", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketProvider }
                );
            });
        }
        ...
        private static void SeedTicketCustomers(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<TicketCustomer>(x =>
            {
                using var hmac = new HMACSHA512();
                x.HasData(
                new TicketCustomer { Id = 1, FirstName = "Kobe", LastName = "Delobelle", GreetingName = "Kobe Delobelle", PhoneNumber = "0473 288 888", Email = "kobe@mail.com", BankAccount = "BE68 5390 0754 7034", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketCustomer },
                new TicketCustomer { Id = 2, FirstName = "Ward", LastName = "Impe", GreetingName = "Ward Impe" , PhoneNumber = "0473 422 458", Email = "ward@mail.com", BankAccount = "BE68 6990 5800 7574", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketCustomer },
                new TicketCustomer { Id = 3, FirstName = "Pieter", LastName = "Corp", GreetingName = "Pieter Corp" , PhoneNumber = "0453 288 888", Email = "Pieter@mail.com", BankAccount = "BE60 5590 0994 7021", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketCustomer },
                new TicketCustomer { Id = 4, FirstName = "Seba", LastName = "Stiaan", GreetingName = "Seba Stiaan" , PhoneNumber = "0485 345 349", Email = "Seba@mail.com", BankAccount = "BE70 5560 1278 7078", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketCustomer },
                new TicketCustomer { Id = 5, FirstName = "Nick", LastName = "Angularlover", GreetingName = "Nick Angularlover", PhoneNumber = "0478 365 852", Email = "Nick@mail.com", BankAccount = "BE77 7893 0824 7304", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketCustomer },
                new TicketCustomer { Id = 6, FirstName = "Dries", LastName = "Maes", GreetingName = "dries Maes" , PhoneNumber = "0432 457 896", Email = "Dries@mail.com", BankAccount = "BE41 7563 7835 0157", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketCustomer },
                new TicketCustomer { Id = 7, FirstName = "Olivia", LastName = "Goossens", GreetingName = "Olivia Goossens", PhoneNumber = "0478 687 138", Email = "Olivia@mail.com", BankAccount = "BE96 4278 6420 5496", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketCustomer },
                new TicketCustomer { Id = 8, FirstName = "Mila", LastName = "Vandevoorde", GreetingName = "Mila Vandevoorde", PhoneNumber = "0485 377 352", Email = "Mila@mail.com", BankAccount = "BE77 1046 8642 5676", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketCustomer },
                new TicketCustomer { Id = 9, FirstName = "Alice", LastName = "Mcgregor", GreetingName = "Alice Mcgregor", PhoneNumber = "0478 785 125", Email = "Alice@mail.com", BankAccount = "BE86 7831 5701 5684", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketCustomer },
                new TicketCustomer { Id = 10, FirstName = "Louise", LastName = "Degroote", GreetingName = "Louise Degroote", PhoneNumber = "0477 765 782", Email = "Louise@mail.com", BankAccount = "BE68 4578 3025 7304", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketCustomer },
                new TicketCustomer { Id = 11, FirstName = "Mohamed", LastName = "Yilmaz", GreetingName = "Mohamed Yilmaz", PhoneNumber = "0472 752 785", Email = "Mohamed@mail.com", BankAccount = "BE89 4785 2015 3065", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketCustomer },
                new TicketCustomer { Id = 12, FirstName = "Emir", LastName = "Öztürk", GreetingName = "Emir Öztürk", PhoneNumber = "0473 478 795", Email = "Emir@mail.com", BankAccount = "BE58 7520 4778 8214", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketCustomer },
                new TicketCustomer { Id = 13, FirstName = "Kurt", LastName = "Debolle", GreetingName = "Kurt Debolle", PhoneNumber = "0478 140 349", Email = "Kurt@mail.com", BankAccount = "BE72 0145 7857 6375", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketCustomer },
                new TicketCustomer { Id = 14, FirstName = "Arthur", LastName = "Vangeest", GreetingName = "Arthur Vangeest", PhoneNumber = "0490 785 457", Email = "Arthur@mail.com", BankAccount = "BE86 4576 0445 4873", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketCustomer },
                new TicketCustomer { Id = 15, FirstName = "Noah", LastName = "Vanarke", GreetingName = "Noah Vanarke", PhoneNumber = "0475 850 852", Email = "Noah@mail.com", BankAccount = "BE69 2467 0468 0478", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketCustomer },
                new TicketCustomer { Id = 16, FirstName = "Victor", LastName = "De Putte", GreetingName = "Victor De Putte", PhoneNumber = "0488 754 752", Email = "Victor@mail.com", BankAccount = "BE88 4785 9785 9620", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), Role = Roles.TicketCustomer }
                );
            });
        }
