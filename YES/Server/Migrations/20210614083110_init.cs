    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 6, 14, 10, 31, 9, 541, DateTimeKind.Local).AddTicks(6606), 1, 1 },
                    { 2, new DateTime(2021, 6, 14, 10, 31, 9, 544, DateTimeKind.Local).AddTicks(4348), 1, 1 },
                    { 3, new DateTime(2021, 6, 14, 10, 31, 9, 544, DateTimeKind.Local).AddTicks(4410), 1, 1 },
                    { 4, new DateTime(2021, 6, 14, 10, 31, 9, 544, DateTimeKind.Local).AddTicks(4417), 1, 1 },
                    { 5, new DateTime(2021, 6, 14, 10, 31, 9, 544, DateTimeKind.Local).AddTicks(4421), 1, 1 },
                    { 6, new DateTime(2021, 6, 14, 10, 31, 9, 544, DateTimeKind.Local).AddTicks(4425), 1, 2 },
                    { 7, new DateTime(2021, 6, 14, 10, 31, 9, 544, DateTimeKind.Local).AddTicks(4430), 1, 2 },
                    { 8, new DateTime(2021, 6, 14, 10, 31, 9, 544, DateTimeKind.Local).AddTicks(4438), 1, 3 },
                    { 9, new DateTime(2021, 6, 14, 10, 31, 9, 544, DateTimeKind.Local).AddTicks(4443), 1, 3 },
                    { 10, new DateTime(2021, 6, 14, 10, 31, 9, 544, DateTimeKind.Local).AddTicks(4447), 1, 3 },
                    { 11, new DateTime(2021, 6, 14, 10, 31, 9, 544, DateTimeKind.Local).AddTicks(4451), 1, 3 },
                    { 12, new DateTime(2021, 6, 14, 10, 31, 9, 544, DateTimeKind.Local).AddTicks(4455), 1, 4 },
                    { 13, new DateTime(2021, 6, 14, 10, 31, 9, 544, DateTimeKind.Local).AddTicks(4459), 1, 4 },
                    { 14, new DateTime(2021, 6, 14, 10, 31, 9, 544, DateTimeKind.Local).AddTicks(4464), 1, 5 },
                    { 15, new DateTime(2021, 6, 14, 10, 31, 9, 544, DateTimeKind.Local).AddTicks(4468), 1, 5 },
                    { 16, new DateTime(2021, 6, 14, 10, 31, 9, 544, DateTimeKind.Local).AddTicks(4472), 1, 5 }
                });
