    ...
    public partial class nit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 6, 14, 9, 19, 22, 557, DateTimeKind.Local).AddTicks(2145), 1, 1 },
                    { 2, new DateTime(2021, 6, 14, 9, 19, 22, 559, DateTimeKind.Local).AddTicks(5948), 1, 1 },
                    { 3, new DateTime(2021, 6, 14, 9, 19, 22, 559, DateTimeKind.Local).AddTicks(5995), 1, 1 },
                    { 4, new DateTime(2021, 6, 14, 9, 19, 22, 559, DateTimeKind.Local).AddTicks(6000), 1, 1 },
                    { 5, new DateTime(2021, 6, 14, 9, 19, 22, 559, DateTimeKind.Local).AddTicks(6004), 1, 1 },
                    { 6, new DateTime(2021, 6, 14, 9, 19, 22, 559, DateTimeKind.Local).AddTicks(6008), 1, 2 },
                    { 7, new DateTime(2021, 6, 14, 9, 19, 22, 559, DateTimeKind.Local).AddTicks(6012), 1, 2 },
                    { 8, new DateTime(2021, 6, 14, 9, 19, 22, 559, DateTimeKind.Local).AddTicks(6016), 1, 3 },
                    { 9, new DateTime(2021, 6, 14, 9, 19, 22, 559, DateTimeKind.Local).AddTicks(6019), 1, 3 },
                    { 10, new DateTime(2021, 6, 14, 9, 19, 22, 559, DateTimeKind.Local).AddTicks(6022), 1, 3 },
                    { 11, new DateTime(2021, 6, 14, 9, 19, 22, 559, DateTimeKind.Local).AddTicks(6025), 1, 3 },
                    { 12, new DateTime(2021, 6, 14, 9, 19, 22, 559, DateTimeKind.Local).AddTicks(6029), 1, 4 },
                    { 13, new DateTime(2021, 6, 14, 9, 19, 22, 559, DateTimeKind.Local).AddTicks(6032), 1, 4 },
                    { 14, new DateTime(2021, 6, 14, 9, 19, 22, 559, DateTimeKind.Local).AddTicks(6036), 1, 5 },
                    { 15, new DateTime(2021, 6, 14, 9, 19, 22, 559, DateTimeKind.Local).AddTicks(6040), 1, 5 },
                    { 16, new DateTime(2021, 6, 14, 9, 19, 22, 559, DateTimeKind.Local).AddTicks(6044), 1, 5 }
                });
