        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 7, "BE96 4278 6420 5496", "Olivia@mail.com", "Olivia", "Goossens", "0478 365 852" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 7, "BE55 7865 7874 1237", "info@sportpaleisgroup.be", "Sportpaleis Group NV", "09 879 87 74" },
                    { 9, "BE55 7865 7874 1237", "info@trix.be", "Team Trix", "09 456 79 17" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 24, "Werchter", "België", "3118", "Festivalpark", 0, null, null, 7 },
                    ...
                    { 26, "Hasselt", "België", "3500", "Kempische Steenweg", 0, null, null, 9 },
                    ...
                    { 27, "Houthalen-Helchteren", "België", "3530", "Binnenvaartstraat", 0, null, null, 10 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, new DateTime(2021, 6, 11, 10, 56, 38, 915, DateTimeKind.Local).AddTicks(9961), 1, 1 },
                    { 5, new DateTime(2021, 6, 11, 10, 56, 38, 915, DateTimeKind.Local).AddTicks(9964), 1, 1 },
                    { 6, new DateTime(2021, 6, 11, 10, 56, 38, 915, DateTimeKind.Local).AddTicks(9967), 1, 2 },
                    { 7, new DateTime(2021, 6, 11, 10, 56, 38, 915, DateTimeKind.Local).AddTicks(9970), 1, 2 },
                    { 8, new DateTime(2021, 6, 11, 10, 56, 38, 915, DateTimeKind.Local).AddTicks(9974), 1, 3 },
                    { 2, new DateTime(2021, 6, 11, 10, 56, 38, 915, DateTimeKind.Local).AddTicks(9838), 1, 1 },
                    { 10, new DateTime(2021, 6, 11, 10, 56, 38, 915, DateTimeKind.Local).AddTicks(9980), 1, 3 },
                    { 11, new DateTime(2021, 6, 11, 10, 56, 38, 915, DateTimeKind.Local).AddTicks(9983), 1, 3 },
                    { 12, new DateTime(2021, 6, 11, 10, 56, 38, 915, DateTimeKind.Local).AddTicks(9986), 1, 4 },
                    { 13, new DateTime(2021, 6, 11, 10, 56, 38, 915, DateTimeKind.Local).AddTicks(9989), 1, 4 },
                    { 14, new DateTime(2021, 6, 11, 10, 56, 38, 915, DateTimeKind.Local).AddTicks(9992), 1, 5 },
                    { 15, new DateTime(2021, 6, 11, 10, 56, 38, 915, DateTimeKind.Local).AddTicks(9997), 1, 5 },
                    { 16, new DateTime(2021, 6, 11, 10, 56, 38, 916, DateTimeKind.Local).AddTicks(1), 1, 5 },
                    { 1, new DateTime(2021, 6, 11, 10, 56, 38, 908, DateTimeKind.Local).AddTicks(8704), 1, 1 },
                    { 3, new DateTime(2021, 6, 11, 10, 56, 38, 915, DateTimeKind.Local).AddTicks(9955), 1, 1 },
                    { 9, new DateTime(2021, 6, 11, 10, 56, 38, 915, DateTimeKind.Local).AddTicks(9977), 1, 3 }
                });
