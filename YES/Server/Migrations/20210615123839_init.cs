    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 6, 15, 14, 38, 38, 485, DateTimeKind.Local).AddTicks(4629), 1, 1 },
                    { 2, new DateTime(2021, 6, 15, 14, 38, 38, 487, DateTimeKind.Local).AddTicks(2641), 1, 1 },
                    { 3, new DateTime(2021, 6, 15, 14, 38, 38, 487, DateTimeKind.Local).AddTicks(2675), 1, 1 },
                    { 4, new DateTime(2021, 6, 15, 14, 38, 38, 487, DateTimeKind.Local).AddTicks(2679), 1, 1 },
                    { 5, new DateTime(2021, 6, 15, 14, 38, 38, 487, DateTimeKind.Local).AddTicks(2683), 1, 1 },
                    { 6, new DateTime(2021, 6, 15, 14, 38, 38, 487, DateTimeKind.Local).AddTicks(2686), 1, 2 },
                    { 7, new DateTime(2021, 6, 15, 14, 38, 38, 487, DateTimeKind.Local).AddTicks(2688), 1, 2 },
                    { 8, new DateTime(2021, 6, 15, 14, 38, 38, 487, DateTimeKind.Local).AddTicks(2691), 1, 3 },
                    { 9, new DateTime(2021, 6, 15, 14, 38, 38, 487, DateTimeKind.Local).AddTicks(2694), 1, 3 },
                    { 10, new DateTime(2021, 6, 15, 14, 38, 38, 487, DateTimeKind.Local).AddTicks(2697), 1, 3 },
                    { 11, new DateTime(2021, 6, 15, 14, 38, 38, 487, DateTimeKind.Local).AddTicks(2699), 1, 3 },
                    { 12, new DateTime(2021, 6, 15, 14, 38, 38, 487, DateTimeKind.Local).AddTicks(2702), 1, 4 },
                    { 13, new DateTime(2021, 6, 15, 14, 38, 38, 487, DateTimeKind.Local).AddTicks(2705), 1, 4 },
                    { 14, new DateTime(2021, 6, 15, 14, 38, 38, 487, DateTimeKind.Local).AddTicks(2708), 1, 5 },
                    { 15, new DateTime(2021, 6, 15, 14, 38, 38, 487, DateTimeKind.Local).AddTicks(2711), 1, 5 },
                    { 16, new DateTime(2021, 6, 15, 14, 38, 38, 487, DateTimeKind.Local).AddTicks(2713), 1, 5 }
                });
