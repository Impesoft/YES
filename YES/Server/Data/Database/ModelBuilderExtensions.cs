    ...
    public static class ModelBuilderExtensions
    {
        ...
        private static void SeedEvents(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Event>(x =>
            {
                ...
                new Event { Id = 10, TicketProviderId = 9, VenueId = 3, Status = Status.Default },
                ...
                new Event { Id = 37, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                new Event { Id = 38, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                ...
                new Event { Id = 43, TicketProviderId = 3, VenueId = 9, Status = Status.Default },
                ...
                new Event { Id = 69, TicketProviderId = 7, VenueId = 12, Status = Status.Default },
        ...
        private static void SeedTicketCategories(ModelBuilder modelBuilder)
        {
            ...
            {
                x.HasData(
                new TicketCategory { Id = 1, Price = 1, MaxAmount = 500, EventId = 1, Name = "zitplaats" }
